...
#Install openshift-install 4.19.9
wget "https://mirror.openshift.com/pub/openshift-v4/x86_64/clients/ocp/4.19.9/openshift-client-linux.tar.gz"
...
wget "https://mirror.openshift.com/pub/openshift-v4/x86_64/clients/ocp/4.19.9/openshift-install-linux-4.19.9.tar.gz"
tar -xvf openshift-install-linux-4.19.9.tar.gz
chmod u+x openshift-install
mv -f openshift-install /usr/local/bin
openshift-install version
rm -rf openshift-install-linux-4.19.9.tar.gz
